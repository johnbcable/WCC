...
var xrefAPIkey = "a78d3c9afdbc9e55ec70894424416bd2ef9373a1263f52115344bd7ea794bb314628f33cf2a983845abc2bd40c26c03d94e8b51932ee2c7cb9d26dc0748f5bd0";
var xrefquery = "list";
var xreftail = "/apiKey="+xrefAPIkey;
	...
	$.ajax({
		...
		success: function(data) {
			...
			if (generatedfiletype == 'DAT') {
			 ...
			 if (generatedfiletype == 'XML') {
				 console.log("XML file chosen");
				 // var xml = json2xml.convert(data.items,"root");
				 // console.log(xml);
				 downloadXML({ data: data.items, filename:  myorgtype+".xml" });
			 }
...
$(document).ready(function() {
	...
	$('#alltruxml').click( function(event) {
		event.preventDefault();
		getOrganisations('HCM_TRU','XML');
	});
